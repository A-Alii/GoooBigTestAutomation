...
public class GoooBig_BoxOperation extends TestBase {
    ...
    public void testcase1(){
        boxOperation = new BoxOperation(driver);
    ...
    public void testcase5(){
        ...
        //String expectedTotalBoxAmount = "10000.0";
        //String actualTotalBoxAmount = boxOperation.getAmountTotalBox();
        //Assert.assertEquals(actualTotalBoxAmount, expectedTotalBoxAmount);
